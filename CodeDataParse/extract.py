...
if __name__ == '__main__':
    ...
    parser.add_argument("-j", "--jar", dest="jar", required=False, default="JavaExtractor/JPredict/target/JavaExtractor")
    parser.add_argument("-dir", "--dir", dest="dir", required=False)
    parser.add_argument("-file", "--file", dest="file", required=False)
    args = parser.parse_args()

    if args.file is not None:
        command = 'java -cp ' + args.jar + ' JavaExtractor.App --file ' + args.file
        os.system(command)
